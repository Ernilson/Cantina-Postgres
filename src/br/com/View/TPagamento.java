...
import static br.com.View.TelaVenda2.VendAdd;
import static br.com.View.TelaVenda2.VendNome;
import static br.com.View.TelaVenda2.VendTable3;
...
public class TPagamento extends javax.swing.JFrame {
    ...
    ServiceCarrinho scr = new ServiceCarrinho();
    ...
    private void Venda() {
        conexao.conector();
         String sql = "insert into venda (codvenda, nome, descricao, qtdp, valor_item, valor_sub_total, valor_total, forma_pg) \n"
                + "select C.codvenda, C.nome, C.descricao, C.qtdp, C.valor_item, C.valor_sub_total, C.valor_total, forma_pg from carrinho C ";
    ...
    private void MostraTotal() {
        conexao.conector();
        try {
            conexao.executaSQL("select valor_sub_total from carrinho order by nome desc;");  // string para habilitar os get's
            conexao.rs.last();

            TxtvalorFinal.setText(conexao.rs.getString("valor_sub_total"));
    ...
    public void som() {
        try {
            File file = new File("C:\\Cantina_Postgres\\src\\br\\com\\zUtils\\Cr.mp3");
    ...
    private void excluir() {
         String sql = "truncate teste cascade ;";
        try {
    ...
    private void excluir2() {
         String sql = "truncate carrinho cascade ;";
        try {
            pst = conexao.conn.prepareStatement(sql);
            pst.executeUpdate();
